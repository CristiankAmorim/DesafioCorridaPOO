...
public class Pista {
    ...
    do{
        ...
        carroDois.corridaIniciar();
         ...
         if(carroUm.getDistancia() > this.tamanhoDaPista){
            carroUm.setDistancia(this.tamanhoDaPista);
         }
            
         if(carroDois.getDistancia() > this.tamanhoDaPista){
            carroDois.setDistancia(this.tamanhoDaPista);
         }
